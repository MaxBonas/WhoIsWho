...
public class CharacterAdapter extends RecyclerView.Adapter<CharacterAdapter.CharacterViewHolder> {
    ...
    public CharacterAdapter(Context context, List<Character> charactersP1, ImageView floatingImageView) {
        ...
        this.currentPlayer = context.getString(R.string.player_1);
    }
        ...
        Runnable enlargeImageRunnable = new Runnable() {
            ...
            public void run() {
                ...
                if (context instanceof MainActivity) {
                    ...
                    RecyclerView currentRecyclerView = context.getString(R.string.player_1).equals(currentPlayer) ? ((LocalPvPActivity) context).characterRecyclerViewP1 : ((LocalPvPActivity) context).characterRecyclerViewP2;
